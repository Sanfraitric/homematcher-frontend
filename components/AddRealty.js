    ...
    <div>
      ...
      <div className={styles.main}>
        <div className={styles.container}>   
          ...
          />
          <label for="file-upload">Ajouter une image</label>
          </div>
            ...
            <ul>
              ...
              <li key={index}>{doc}</li>
                ...
                <div className={styles.buttonAdd}>
                  <input type="file" id="fileInput" multiple onChange={handleFileSelect} className={styles.inputFile} />
                  <label onClick={handleButtonClick}>Ajouter vos documents</label>
